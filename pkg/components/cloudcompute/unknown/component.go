...
var UnknownComponent = Component{
	Component: &config.Component{
		...
		Matchers: []config.ComponentMatcher{
			...
			{Suite: "Cluster_Infrastructure MAPI"},
			{Suite: "Cluster_Infrastructure CAPI"},
			{Suite: "Cluster_Infrastructure CMA"},
			{Suite: "Cluster_Infrastructure CPMS MAPI"},
			{Suite: "Cluster_Infrastructure Upgrade"},
		},
	},
}
